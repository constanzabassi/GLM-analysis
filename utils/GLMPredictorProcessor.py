...
class GLMPredictorProcessor:
    ...
    def get_fold_test_path(self, server, animalID, date, model_type, fold_number, default_context = 'VR'):
        """
        ...
        return os.path.join(save_directory, f"{default_context}_{fold_number + 1}", "test")
